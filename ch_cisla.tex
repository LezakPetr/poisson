...
Nakonec rozšiřme definici mocniny na celočíselné mocněnce a~mocnitele. Začněme rozšířením mocněnce. Podle definice~\eqref{eq:power_definition} je zřejmé, že mezi sebou budeme násobit záporná čísla. Vztahy~\eqref{eq:natural_power_by_one} a~\eqref{eq:natural_power_distributivity} proto zůstanou zachovány i~pro záporné mocněnce, jak udávají rovnice~\eqref{eq:rational_power_by_one} a~\eqref{eq:rational_power_distributivity}.
