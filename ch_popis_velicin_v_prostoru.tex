...
\begin{equation}
\begin{split}
\frac{\mathrm{d}y}{\mathrm{d}x} a^x = \frac{\mathrm{d}}{\mathrm{d}x} a^x = \lim_{dx \to 0} \frac{a^{x+dx} - a^x}{dx} = \lim_{dx \to 0} \frac{a^x \cdot a^{dx} - a^x}{dx} = \\
...
\draw[domain=-2:2, smooth, variable = \x] plot ({\x}, {pow(1.5, \x)});
\draw[domain=-2:2, smooth, variable = \x] plot ({\x}, {pow(2, \x)});
\draw[domain=-2:1.5129, smooth, variable = \x] plot ({\x}, {pow(2.5, \x)});
\draw[domain=-2:1.2619, smooth, variable = \x] plot ({\x}, {pow(3, \x)});
