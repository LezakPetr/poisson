...
Uvědomíme-li si, že z~\(\varepsilon_g \leq \delta_f(\varepsilon_f)\) tak platí

\begin{equation}
\overset{\circ}{U}_{\varepsilon_g}(Q_0) \subset \overset{\circ}{U}_{\delta_f(\varepsilon_f)}(Q_0)
\end{equation}

a~my můžeme první rovnici specializovat:

\begin{equation}
\forall Q \in \overset{\circ}{U}_{\varepsilon_g}(Q_0) \; \mathrm{f}(Q) \in U_{\varepsilon_f}(y)
\end{equation}

Využijeme druhé rovnice. Plyne z~ní, že podmínka \(Q \in \overset{\circ}{U}_{\varepsilon_g}(Q_0)\) je splněna pokud \(P \in \overset{\circ}{U}_{\delta_g(\varepsilon_g)}(P_0)\) a~my ji tak můžeme do rovnice zapsat pokud nahradíme \(Q = \mathrm{g}(P)\) a~\(\varepsilon_g = \delta_f(\varepsilon_f)\):
