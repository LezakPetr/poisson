...
\begin{equation}
\forall \varepsilon > 0 \; \exists \delta > 0 \; \forall P \in (U_{\delta}(P_0) \setminus P_0) \; |\mathrm{f}(P) - y| < \varepsilon
\end{equation}
...
\begin{equation}
\begin{split}
\forall P \in (U_{\delta_f(\frac{\varepsilon}{2})}(P_0) \setminus P_0) \; \left| \mathrm{f}(P) - \lim_{P \to P_0} \mathrm{f}(P)\right| < \frac{\varepsilon}{2} \\
\forall P \in (U_{\delta_g(\frac{\varepsilon}{2})}(P_0) \setminus P_0) \; \left| \mathrm{g}(P) - \lim_{P \to P_0} \mathrm{g}(P)\right| < \frac{\varepsilon}{2}
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
U_{\delta(\varepsilon)}(P_0) \subset U_{\delta_f(\frac{\varepsilon}{2})}(P_0) \\
U_{\delta(\varepsilon)}(P_0) \subset U_{\delta_g(\frac{\varepsilon}{2})}(P_0)
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\forall P \in (U_{\delta(\varepsilon)}(P_0) \setminus P_0) \; \left| \mathrm{f}(P) - \lim_{P \to P_0} \mathrm{f}(P)\right| < \frac{\varepsilon}{2} \\
\forall P \in (U_{\delta(\varepsilon)}(P_0) \setminus P_0) \; \left| \mathrm{g}(P) - \lim_{P \to P_0} \mathrm{g}(P)\right| < \frac{\varepsilon}{2}
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\forall P \in (U_{\delta(\varepsilon)}(P_0) \setminus P_0) \; \left| \mathrm{f}(P) - \lim_{P \to P_0} \mathrm{f}(P)\right| + \left| \mathrm{g}(P) - \lim_{P \to P_0} \mathrm{g}(P)\right| < 2 \cdot \frac{\varepsilon}{2} \\
\forall P \in (U_{\delta(\varepsilon)}(P_0) \setminus P_0) \; \left| \left(\mathrm{f}(P) - \lim_{P \to P_0} \mathrm{f}(P)\right) \pm \left( \mathrm{g}(P) - \lim_{P \to P_0} \mathrm{g}(P)\right)\right| < \varepsilon \\
\forall P \in (U_{\delta(\varepsilon)}(P_0) \setminus P_0) \; \left| \left(\mathrm{f}(P) \pm \mathrm{g}(P) \right) - \left(\lim_{P \to P_0} \pm \lim_{P \to P_0} \mathrm{g}(P)\right)\right| < \varepsilon \\
\end{split}
\end{equation}
