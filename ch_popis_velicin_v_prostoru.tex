...
\begin{equation}
\mathrm{f}(\mathrm{g}_1(x), \mathrm{g}_2(x), ..., \mathrm{g}_n(x))
\end{equation}

začněme nejdříve vztahem

\begin{equation}
\lim_{\mathrm{d}x \to 0} \frac{\mathrm{f}(\mathrm{g}_1(x + \mathrm{d}x), \mathrm{g}_2(x + \mathrm{d}x), ..., \mathrm{g}_n(x + \mathrm{d}x)) - \mathrm{f}(\mathrm{g}_1(x), \mathrm{g}_2(x + \mathrm{d}x), ..., \mathrm{g}_n(x + \mathrm{d}x))}{\mathrm{d}x}
\end{equation}
