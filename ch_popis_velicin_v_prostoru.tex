...
Začněme limitou součtu nebo rozdílu. Ta je rovna součtu nebo rozdílu limit pokud existují:

\begin{equation}
\lim_{x \to x_0} \left(\mathrm{f}(x) \pm \mathrm{g}(x) \right) = \lim_{x \to x_0} \mathrm{f}(x) \pm \lim_{x \to x_0} \mathrm{g}(x)
\end{equation}
