...
Zabývejme se tím, jak vícerozměrný integrál vypočítat. Nechť \(\Omega\) je hyperkvádr se stranamy \(a \leq x \leq b\), \(c \leq y \leq d\) atd. Rozepišme vztah~\eqref{eq:vypocet_vycerozmerneho_integralu}: 
