...
Začněme dvěma kovariantními vektory. Máme-li součin \(T_{ij} = u_i \cdot v_j\), pak transformovaný součin bude \(T'_{ij} = u'_i \cdot v'_j = (\sum_{k=1}^n \frac{\partial p'_k}{\partial P_i} \cdot u_k) \cdot (\sum_{l=1}^n \frac{\partial p'_l}{\partial P_j} \cdot v_l) = \sum_{k=1}^n \sum_{l=1}^n \frac{\partial p'_k}{\partial P_j} \cdot \frac{\partial p'_l}{\partial P_i} \cdot u_k \cdot v_l\). Součin sum jsme prostě roznásobili. Například \((\sum_{i=1}^3 a_i) \cdot (\sum_{j=1}^3 b_j) = (a_1 + a_2 + a_3) \cdot (b_1 + b_2 + b_3) = a_1 b_1 + a_1 b_2 + a_1 b_3 + a_2 b_1 + a_2 b_2 + a_2 b_3 + a_3 b_1 + a_3 b_2 + a_3 b_3 = \sum_{i=1}^3 \sum_{j=1}^3 a_i b_i\).
