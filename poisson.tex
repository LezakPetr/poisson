...
Pokud budeme integrovat rovnici \eqref{eq:reseni_primka_1}, získáme rovnici \eqref{eq:reseni_primka_2}. Druhou integrací získáme obecné
řešení \eqref{eq:reseni_primka_3}.

\begin{equation}
\label{eq:reseni_primka_1}
\frac{\partial^2 \varphi}{\partial x^2} = f
\end{equation}

\begin{equation}
\label{eq:reseni_primka_2}
\frac{\partial \varphi}{\partial x} = \int f dx + C_1
\end{equation}

\begin{equation}
\label{eq:reseni_primka_3}
\frac{\partial \varphi}{\partial x} = \iint f dx + C_1 x + C2
\end{equation}
