...
bodu je pak \(n\)-tice čísel odpovídajících orientovaným vzdálenostem průmětu bodu do jednotlivých souřadnicových os. Metrika je pak \(d(u, v) = \sqrt{\sum_{i=1}^n (u_i - v_i)^2}\).
