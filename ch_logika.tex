...
Dále dokážeme, že v~implikaci z~předpokladu plyne závěr. Důkaz provedeme postupným upravováním výrazu pomocí dříve dokázaných vztahů. Důkaz je záměrně proveden krok po kroku, aby bylo zřejmé, kterých vztahů využíváme:

\eeq{impl_usage_proof}

Nejdřív jsme rozepsali první implikaci na disjunkci. Pak jsme použili distributivitu konjunkce a~"roznásobili" disjunkci. První takto vzniklý člen je vždy nepravdivý, protože nemůže být pravdivý výrok \(\predicate{A}\) i~jeho negace. Protože se tento nepravdivý člen vyskytuje v~disjunkci, tak ho můžeme odstranit. Následně nahradíme zbývající implikaci disjunkcí. Na takto vzniklou negaci konjunkce použijeme De-Morganovo pravdidlo. Vznikne tak disjunkce, ve které se vyskytuje výrok 
\(\predicate{B}\) i~jeho negace. Díky zákonu o~vyloučení třetího je pak tato disjunkce vždy pravdivá a~tím i celý výrok.
