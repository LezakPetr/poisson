	...
	print_validated_formula(
		...
		declare_variable(X, 'x', Values,
			declare_variable(Y, 'y', Values,
				num_equal([(X + Y) * (X - Y), X^2 - Y^2], 1e-12)
			)
		)
	).
\end{prolog}
...
?- 	make_test_values(Values),
	print_validated_formula(
		...
		declare_variable(X, 'x', Values,
			declare_variable(Y, 'y', Values,
				num_equal([(5*X + 4*Y) * (5*X - 4*Y), (5*X)^2 - (4*Y)^2], 1e-12)
			)
		)
	).
\end{prolog}
...
?- 	make_test_values(Values),
	print_validated_formula(
		...
		declare_variable(X, 'x', Values,
			declare_variable(Y, 'y', Values,
				num_equal([2 * (5*X + 4*Y) * (5*X - 4*Y), 2 * (5*X + 4*Y) * (5*X - 4*Y)], 1e-12)
			)
		)
	).
\end{prolog}
...
?- 	make_test_values(Values),
	print_validated_formula(
		...
		declare_variable(X, 'x', Values,
			declare_variable(Y, 'y', Values,
				num_equal([2 * (5*X + 4*Y) * (5*X - 4*Y), 2 * ((5*X)^2 - (4*Y)^2)], 1e-12)
			)
		)
	).
\end{prolog}
