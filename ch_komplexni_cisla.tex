...
\draw (\r * \xb, \r * \yb) -- (\r * \x, \r * \y) -- (\r * \xb, \r * \y) -- (\r * \xb, \r * \yb);
...
\draw (\r * \xb, \r * \y / 2 + \r * \yb / 2) node[anchor=east]{\(\mathrm{d}\alpha \cdot \cos \alpha\)};
\draw (\r * \x / 2 + \r * \xb / 2, \r * \y) node[anchor=north]{\(\mathrm{d}\alpha \cdot \sin \alpha\)};
