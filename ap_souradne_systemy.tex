...
\draw (1, 0) node[anchor=west]{\(r=r_0\)};

\draw[thick] (0, 0) -- (1, 1);
\draw (1, 1) node[anchor=west]{\(\alpha=\alpha_0\)};
...
\draw (0.70711, -0.70711) node[anchor=west]{\(r=r_0\)};
...
\draw (0, 2) node[anchor=west]{\(\alpha=\alpha_0\)};
...
\draw (1.2247, 0) node[anchor=west]{\(r=r_0\)};
...
\draw[dashed] (0, 0) -- (1, -1);
\draw (1, -1) node[anchor=west]{\(\beta=\beta_0\)};
